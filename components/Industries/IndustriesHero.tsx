  ...
  return (
    <div className="min-h-[80vh] flex items-center relative overflow-hidden bg-gray-900">
      <div className="absolute inset-0 z-0">
        ...
        <img
          src="https://images.unsplash.com/photo-1553547274-0df401ae03c9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2340&q=80"
